...
const isES2015ReservedWord = word => {
...
function isStrictBindReservedWord(word) {
  return word === "eval" || word === "arguments";
}
const keywords$1 = new Set(["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "while", "with", "null", "true", "false", "instanceof", "typeof", "void", "delete", "new", "in", "this", "let", "const", "class", "extends", "export", "import", "yield", "super"]);
...
class ExpressionParser extends LValParser {
  ...
  checkReservedWord(word, startLoc, checkKeywords, isBinding) {
    if (this.state.strict && (isStrictReservedWord(word) || isBinding && isStrictBindReservedWord(word))) {
...
class StatementParser extends ExpressionParser {
  ...
  parseDoStatement(node) {
    ...
    node.body = this.withTopicForbiddingContext(() => this.parseStatement(false));
    ...
    if (this.match(types._var) || this.match(types._let) || this.match(types._const)) {
      ...
      if (this.match(types._in) || this.isContextual("of")) {
        if (init.declarations.length === 1) {
          ...
          const isForInInitializer = varKind === types._var && declaration.init && declaration.id.type != "ObjectPattern" && declaration.id.type != "ArrayPattern" && !this.isContextual("of");
  ...
  parseLabeledStatement(node, maybeName, expr, declaration) {
